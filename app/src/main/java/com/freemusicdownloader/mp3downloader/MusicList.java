...
public class MusicList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mylist = (SwipeMenuListView)findViewById(R.id.listemm);
        mp = new MediaPlayer();
        mydialog = new ProgressDialog(MusicList.this);
        android.support.v7.app.ActionBar actionBar = getSupportActionBar();
        // actionBar.setNavigationMode(ActionBar.NAVIGATION_MODE_LIST);
        actionBar.setDisplayShowHomeEnabled(true);
        actionBar.setTitle("Downloaded Musics");
        //actionBar.setIcon(R.drawable.ic_library_music_black_24dp);
        ...
        adapterListMusics = new customAdapterListMusics(getApplication(), getAllMusics(pathControl()), listMusicNameCont, listMusicName, listMusicTime);
        ...
        if (mylist.getAdapter().getCount() != 0)
        {
            ...
            AudienceNetworkAds.facebookInterstitialAd(MusicList.this,ads_layout,avLoadingIndicatorView);
        }
...
//    }
    ...
    public String pathControl() {
        ...
        if (path != null) {
            ...
            path = getApplication().getFilesDir() + File.separator+ "Mp3Download/";
